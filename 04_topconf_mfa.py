...
from models import *
from utils import dataset_split, init_func

def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--data-dir', default='../data', type=str)
    parser.add_argument('--batch-size', default=512, type=int)
    parser.add_argument('--fname', default='04_topconf_mfa', type=str)
    ...
    parser.add_argument('--perturb-type', default='distill', type=str, choices=['target', 'distill'])
